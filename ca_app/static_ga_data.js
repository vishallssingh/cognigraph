    ...
    "subsections": [
      {
        ...
        "rows": [
          [
            ...
            "Dec 11, 2024",
            "Shaktikanta Das",
            "1990-batch IAS (Rajasthan); served as Revenue Secretary in Ministry of Finance."
          ],
          [
            "Tuhin Kanta Pandey",
            "Chairperson",
            ...
            "March 1, 2025",
            "Madhabi Puri Buch",
            "1987-batch IAS (Odisha); served as Finance Secretary and DIPAM Secretary."
          ],
          [
            "Ajay Seth",
            "Chairperson",
            ...
            "Sept 1, 2025",
            "Debasish Panda",
            "1987-batch IAS (Karnataka); served as Finance Secretary and Economic Affairs (DEA) Secretary."
          ],
          [
            ...
            "June 20, 2025",
            "Deepak Mohanty",
            "Appointed for 5-year term (or till age 65); former SIDBI Chairman."
          ],
          [
            "K. Rajaraman",
            "Chairperson",
            ...
            "Aug 1, 2023",
            "Initial Term",
            "1989-batch IAS (Tamil Nadu); tenure extended in July 2026 for 27 months (till Oct 2028)."
          ]
        ]
      },
      {
      ...
      },
      {
        ...
        "rows": [
          [
            ...
            "Aug 28, 2024",
            "Succeeded Dinesh Kumar Khara (3-year term)."
          ],
          [
            "Brajesh Kumar Singh",
            "MD & CEO",
            "Canara Bank",
            "May 30, 2026",
            "Succeeded K. Satyanarayana Raju."
          ],
          [
            "Ashok Chandra",
            "MD & CEO",
          ...
          [
            ...
            "Bank of India",
            "April 2026",
            "Term extended for 3 years by central government."
          ],
          [
            "Shaji K. V.",
            "Chairman",
          ...
          [
            ...
            "NaBFID",
            "Aug 8, 2022",
            "Appointed for term ending May 18, 2027."
          ],
          [
            "Manoj Mittal",
            "Chairman & MD",
            "SIDBI",
            "July 2024",
            "Succeeded Sivasubramanian Ramann."
          ],
          [
            "Sanjay Shukla",
            "Managing Director",
      ...
      },
      {
        ...
        "rows": [
          [
            ...
            "Assured Benefit (Contributory-Linked)"
          ],
          [
          ...
          [
            "Employer/Govt Contribution",
            "Funded by Govt budget",
            "14% of Basic + DA",
            "18.5% of Basic + DA"
          ],
          [
            ...
            "Yes (DA linked)",
            "No (Market dependent)",
            "Yes (DR linked to AICPI-IW)"
          ],
          [
            "Minimum Pension",
            "No explicit floor",
            "No floor",
            "₹10,000/month (Min 10 yrs service)"
          ],
          [
            "Lump-Sum at Exit",
            "Gratuity only",
            "Up to 80% (2025 Amendment)",
            "Gratuity + 1/10th basic+DA per 6-m service"
          ]
        ]
      },
      {
        "subId": "ch2-sub3",
        "title": "Monetary Policy Instruments Deep Dive (Direct vs Indirect Tools)",
        "type": "examCorner",
        "items": [
          "**DIRECT INSTRUMENTS (Statutory Reserve Mandates):**\n• Cash Reserve Ratio (CRR): Mandatory cash reserves held with RBI under Section 42(1) RBI Act.\n• Statutory Liquidity Ratio (SLR): Mandatory liquid assets held under Section 24 BR Act 1949.",
          "**INDIRECT INSTRUMENTS (Market Liquidity Facilities):**\n• Repo & Reverse Repo: Overnight collateralized lending/borrowing benchmark.\n• Standing Deposit Facility (SDF): Uncollateralized deposit floor window (6.25%).\n• Marginal Standing Facility (MSF): Emergency overnight borrowing ceiling window (6.75%).\n• Open Market Operations (OMO): Outright purchase/sale of G-Secs for durable liquidity."
        ]
      }
    ]
  },
      ...
      },
      {
        ...
        "rows": [
          [
            ...
            "40% of ANBC / CEOBSE",
            "Agri: 18% (Small/Marginal Farmers: 10%), Micro Enterprises: 7.5%, Weaker Sections: 12%"
          ],
          [
          ...
          [
            ...
            "75% of ANBC",
            "Micro Enterprises: 7.5%, Small/Marginal Farmers: 10%, Weaker Sections: 15%"
          ],
          [
            "Urban Co-operative Banks (UCBs)",
            "75% of ANBC (Effective March 31, 2026)",
            "Weaker Sections: 12% (Effective March 31, 2026)"
          ]
        ]
      },
      {
    ...
    "subsections": [
      {
        ...
        "rows": [
          [
            ...
            "2022–23",
            "MoSPI (NSO)",
            "GST databases, MCA-21, PLFS data; implements double deflation."
          ],
          [
            ...
            "2022–23",
            "MoSPI (NSO)",
            "Updated production data, renewable energy, electronics/telecom."
          ],
          [
            ...
            "2024",
            "MoSPI (NSO)",
            "HCES 2022-23 findings; basket expanded to 358 items."
          ],
          [
            ...
            "Iron Ore added as 9th core industry (32.88% IIP weight)."
          ]
        ]
      },
      {
        "subId": "ch4-sub2",
        "title": "Inflation Indices & RBI Target Framework (CPI vs WPI Comparison)",
        "type": "table",
        "headers": [
          "Index Parameter",
          "Consumer Price Index (CPI)",
        ...
        "rows": [
          ...
          [
            ...
            "Office of Economic Adviser (DPIIT, MoCI)"
          ],
          [
            "Food Basket Weight",
            "45.86% (Highest)",
          ...
          [
            "RBI Policy Target Anchor",
            "Mandatory Anchor (4% ± 2%)",
            "Not used as policy anchor"
          ]
        ]
      },
      {
    ...
    "subsections": [
      {
        ...
        "rows": [
          [
            "World Bank Group",
            "Washington D.C., USA",
            "Ajay Banga (14th President)",
            "Indermit Gill (Chief Economist & Senior VP)",
            "189 (IBRD)"
          ],
          [
            ...
            "Gita Gopinath (First Deputy MD)",
            "190"
          ],
          [
            "Asian Development Bank (ADB)",
            "Mandaluyong (Manila), Philippines",
            "Masato Kanda (President, Feb 2026)",
            "Bhargav Dasgupta (Vice President)",
            "68"
          ],
          [
      ...
      },
      {
        ...
        "rows": [
          [
            ...
            "7.2%",
            "6.6% – 6.9%",
            "Cautious hold; monsoon & crude oil impact."
          ],
          [
          ...
          [
            ...
            "6.9%",
            "7.3%",
            "Rebound in FY27 via domestic demand."
          ],
          [
            "World Bank",
            "7.0%",
          ...
          [
            ...
            "7.0%",
            "6.4%",
            "Anchored inflation; public capex push."
          ],
          [
            "S&P Global Ratings (CRISIL)",
            "6.5%",
            "6.9%",
          ...
          [
            ...
            "7.2%",
            "6.5%",
            "Robust manufacturing & credit growth."
          ]
        ]
      },
      {
    ...
    "subsections": [
      {
        ...
        "headers": [
          ...
          "Repatriability Status",
          "Taxability in India",
          "Eligible Depositors / Source"
        ],
        "rows": [
          [
            ...
            "Tax-Exempt (Interest exempt)",
            "NRIs/PIOs using foreign earnings from abroad."
          ],
          [
            "NRO (Non-Resident Ordinary)",
            "INR (Indian Rupee)",
            "Restricted / Partial (Up to $1M/yr under LRS)",
            "Taxable (Subject to TDS & DTAA)",
            "Used to manage income earned within India (rent, pension)."
          ],
          [
            ...
            "Fully & Freely Repatriable",
            "Tax-Exempt",
            "Kept strictly as Term/Fixed Deposits (1 to 5 years)."
          ],
          [
            ...
            "Business operations in India by foreign entities (non-interest bearing)."
          ]
        ]
      },
      {
      ...
      },
      {
        ...
        "rows": [
          [
            ...
            "Unconditional promise in writing signed by maker."
          ],
          [
            "Bill of Exchange",
            "Section 5",
            "3 Parties: Drawer, Drawee, Payee",
            "Unconditional order in writing directing drawee to pay."
          ],
          [
            "Cheque",
            "Section 6",
            "3 Parties: Drawer, Drawee (Banker), Payee",
            "Bill of Exchange drawn on a specified banker, payable on demand. Validity: 3 months."
          ]
        ]
      },
      {
    ...
    "subsections": [
      {
        ...
        "rows": [
          [
            "Bank Rate",
            "5.75%",
            "Long-term lending rate without collateral; linked to MSF rate.",
            "RBI -> Banks"
          ],
          [
            "Marginal Standing Facility (MSF)",
            "5.75%",
            "Emergency overnight borrowing rate (up to 2% SLR dip penalty). LAF Corridor Ceiling.",
            "RBI -> Banks"
          ],
          [
            "Policy Repo Rate",
            "5.25%",
            "Overnight lending rate against G-Secs collateral. Central policy anchor.",
            "RBI -> Banks"
          ],
          [
            "Standing Deposit Facility (SDF)",
            "5.00%",
            "Uncollateralised excess liquidity absorption rate. LAF Corridor Floor.",
            "Banks -> RBI"
          ],
          [
            "Cash Reserve Ratio (CRR)",
            "4.00%",
            "Proportion of NDTL kept as cash with RBI (earns ZERO interest).",
            "Statutory Buffer"
          ],
          [
            "Statutory Liquidity Ratio (SLR)",
            "18.00%",
            "Proportion of NDTL maintained in liquid assets (G-Secs, Gold, Cash).",
      ...
      },
      {
        ...
        "rows": [
          [
            "FDI in Insurance",
            "74% (Automatic Route)",
            "100% (Full FDI permitted under governance rules)"
          ],
          [
            "Composite Licenses",
            "Separate licenses for Life, General, Health",
            "Single entity can apply for a Composite License (Life + General + Health)"
          ],
          [
            "Capital Norms",
            "₹100 crore fixed minimum paid-up capital",
            "Differentiated capital norms for different risk categories"
          ],
          [
            "Surrender Value",
            "Longer lock-ins before guaranteed value",
            "Guaranteed surrender value from end of 1st policy year"
          ]
        ]
      },
      {
    ...
    "subsections": [
      {
        ...
        "headers": [
          "Parameter",
          "MGNREGA 2005 (Repealed)",
          "VB-G RAM G Act 2025 (Effective July 1, 2026)"
        ],
        "rows": [
          [
            "Statutory Guarantee",
            "100 days per household per FY",
            "125 days per household per FY (enhanced by 25 days)"
          ],
          [
            "Funding Model",
            "Demand-based (100% wages, 75% material)",
            "Normative Budget Model (60:40 Centre:State; States bear excess)"
          ],
          [
            "Agricultural Pause",
            "No explicit statutory pause window",
            "State Pause Window up to 60 days during peak sowing/harvesting"
          ],
          [
            "Administrative Cap",
            "6% of total outlay",
            "9% of total outlay (enhanced for tech & capacity building)"
          ],
          [
            "Attendance System",
            "Manual / NMMS app",
            "NMMS-enabled + Face Authentication-based systems"
          ]
        ]
      },
      {
